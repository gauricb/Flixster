...
* [Completed] For each movie displayed, user can see the following details:
  * [Completed ] Title, Poster Image, Overview (Portrait mode)
  * [ Completed] Title, Backdrop Image, Overview (Landscape mode)
...
Given the short amount of time we had to do this porject I struggled to complete this project on time. 
If I had one more day I could have implemented some of the stretch features.
